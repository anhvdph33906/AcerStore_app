 ...
 * @author Admin
 */
public class ManCho extends javax.swing.JDialog {

    /**
     * Creates new form ManCho
     */
    public ManCho(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        runLoadingBar();
            ...
            public void run() {
                ...
                for (int i = 0; i <= 100; i++) {
                    try {
                        ...
                        Logger.getLogger(ManCho.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/acerstore/app/icon/loading.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManCho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ManCho dialog = new ManCho(new javax.swing.JFrame(), true);
